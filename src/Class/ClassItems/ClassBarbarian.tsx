        ...
        <div className="class-item__abilities">
          ...
          <div className="race-item__items">
            ...
            <p className="race-item__item">
              ...
              <p>Медведь</p>В состоянии Ярости Вы получаете сопротивление ко
              ...
              <p>Орёл</p> Когда Вы находитесь в состоянии Ярости и не носите
              тяжёлых доспехов, другие существа совершают провоцированные атаки
              по Вам с помехой. В свой ход Вы можете совершать Рывок бонусным
              действием. Дух орла превращает Вас в хищника, с лёгкостью
              носящегося по полю боя.
              <p>Лось</p>Когда вы находитесь в состоянии ярости и не носите
              тяжёлых доспехов, ваша скорость ходьбы увеличивается на 15 футов.
              Дух лося делает вас необычайно подвижным.
              <p>Тигр</p>Пока вы находитесь в ярости, вы можете добавить 10
              футов к дальности вашего прыжка в длину и 3 фута к прыжку в
